...
点击 [这里](https://codeload.github.com/damonnie/hexo-theme-matery/zip/master) 下载 `master` 分支的最新稳定版的代码，解压缩后，将 `hexo-theme-matery` 的文件夹复制到你 Hexo 的 `themes` 文件夹中即可。

当然你也可以在你的 `themes` 文件夹下使用 `Git clone` 命令来下载:

```bash
git clone https://github.com/damonnie/hexo-theme-matery.git
```
...
```html
<a href="https://github.com/damonnie" class="tooltipped" target="_blank" data-tooltip="访问我的GitHub" data-position="top" data-delay="50">
...
![](https://user-gold-cdn.xitu.io/2019/9/18/16d432179164a4f1?imageslim)

Gantzert_Felixander：

![](https://user-gold-cdn.xitu.io/2019/9/18/16d432179bcce33f?imageslim "")
ni-j：

![](https://user-gold-cdn.xitu.io/2019/9/18/16d4321812725510?imageslim "")
nico：

![](https://user-gold-cdn.xitu.io/2019/9/18/16d43218304b10d6?imageslim "")
shizuku：

![](https://user-gold-cdn.xitu.io/2019/9/18/16d43217e3c25e0a?imageslim "")
z16：
